...
var networksResource = schema.GroupVersionResource{Group: "samplecrd.nuzar.top", Version: "v1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "samplecrd.nuzar.top", Version: "v1", Kind: "Network"}
