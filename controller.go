...
import (
	...
	samplecrdv1 "github.com/fusidic/k8s-custom-controller/pkg/apis/samplecrd/v1"
	clientset "github.com/fusidic/k8s-custom-controller/pkg/client/clientset/versioned"
	networkscheme "github.com/fusidic/k8s-custom-controller/pkg/client/clientset/versioned/scheme"
	informers "github.com/fusidic/k8s-custom-controller/pkg/client/informers/externalversions/samplecrd/v1"
	listers "github.com/fusidic/k8s-custom-controller/pkg/client/listers/samplecrd/v1"
)

const controllerAgentName = "network-controller"

const (
	// SuccessSynced is used as part of the Event 'reason' when a Netwokr is synced
...
type Controller struct {
	// kubeclientst is a standard kubernetes client
	...
	// means we can ensure we only process a fixed amount of resouces at a
...
func (c *Controller) processNextWorkItem() bool {
	...
	err := func(obj interface{}) error {
		...
		var key string
		var ok bool
		// We expect string to come off the workqueue. These are of the
		// form namespace/name. We do this as the delayed nature of the
		// workqueue means the items in the informer cache may actuall be
		...
		if key, ok = obj.(string); !ok {
			...
			runtime.HandleError(fmt.Errorf("expected sting in workqueue but got %#v", obj))
			return nil
		}
		// Run the syncHandler, passing it the namespacename string of the
...
func (c *Controller) syncHandler(key string) error {
	// Convert the namespace/anme string into a distinct namespace and name
...
// enqueueNetworkForDelete takes a deleted Network resource and converts it into a namespace/anem
// string which is then put onto the work queue. This method should *not* be
// passed resources of any type other than Network.
